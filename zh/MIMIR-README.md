...
│   └── templates/
│
├── convention-extraction/              # 🟢 构建 — 跨模块约定一致性
│   └── SKILL.md                        # 提取维度、快照格式
│
...
| 版本 | 日期 | 更新内容 |
|------|------|----------|
| v1.9 | 2026-02-04 | 添加约定提取 skill：通过约定快照实现跨模块一致性 |
| v1.8 | 2026-02-04 | 添加 Review Agent skill：独立代码审查、生命周期阶段（规划 → 构建 → 验证 → 反思 → 复盘）|
...
| v1.4 | 2026-01-31 | 添加核心原则 (CORE-PRINCIPLES.md) 和 Claude Code Prompt Skill，基于 Task Decomposition 验证实践 |
| v1.3 | 2026-01-30 | 添加元知识提炼 Skill (meta-knowledge/) |
| v1.2 | 2026-01-28 | 添加文档一致性管理模板 |
| v1.1 | 2026-01-27 | 添加测试策略、文档交付阶段 |
